 ...
 */
@Order(100)
//@ControllerAdvice // 不能使用，会扫描到，需要用GracefulResponseAutoConfig初始化
public class CustomValidationExceptionAdvice extends DefaultValidationExceptionAdvice {

    private final Logger logger = LoggerFactory.getLogger(CustomValidationExceptionAdvice.class);
