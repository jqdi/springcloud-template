...
# 启动脚本
# 前置准备：
# 1. 准备好服务器根目录'../应用根目录/template-tool'
# 2. 将本脚本复制到'应用根目录/template-tool/startup.sh'
# 3. 复制cicd/plugins/到'应用根目录/template-tool/plugins/'
# 4. 将template-tool.jar上传至'应用根目录/template-tool/template-tool.jar'
