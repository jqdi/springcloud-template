...
# 启动脚本
# 前置准备：
# 1. 准备好服务器根目录'../应用根目录/template-eureka'
# 2. 将本脚本复制到'应用根目录/template-eureka/startup.sh'
# 3. 将template-eureka.jar上传至'应用根目录/template-eureka/template-eureka.jar'


# 应用名，建议与spring.application.name保持一致
MODULE="template-eureka"
