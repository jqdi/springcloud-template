...
# 启动脚本
# 前置准备：
# 1. 准备好服务器根目录'../应用根目录/template-order'
# 2. 将本脚本复制到'应用根目录/template-order/startup.sh'
# 3. 复制cicd/plugins/到'应用根目录/template-order/plugins/'
# 4. 将template-order.jar上传至'应用根目录/template-order/template-order.jar'
